...
T: dict[str, dict[str, str]] = {
    "MusicMatch clásico · Gris azulado": {"en": "Classic MusicMatch · Blue gray", "pt": "MusicMatch clássico · Cinza azulado", "fr": "MusicMatch classique · Gris bleuté", "de": "Klassisches MusicMatch · Blaugrau", "it": "MusicMatch classico · Grigio blu"},
    ...
    "Privacidad": {"en": "Privacy", "pt": "Privacidade", "fr": "Confidentialité", "de": "Datenschutz", "it": "Privacy"},
    "Mostrar barra de menú clásica": {"en": "Show classic menu bar", "pt": "Mostrar barra de menu clássica", "fr": "Afficher la barre de menus classique", "de": "Klassische Menüleiste anzeigen", "it": "Mostra la barra dei menu classica"},
    "Archivo": {"en": "File", "pt": "Arquivo", "fr": "Fichier", "de": "Datei", "it": "File"},
    "Editar": {"en": "Edit", "pt": "Editar", "fr": "Édition", "de": "Bearbeiten", "it": "Modifica"},
    "Ver": {"en": "View", "pt": "Exibir", "fr": "Affichage", "de": "Ansicht", "it": "Visualizza"},
    "Ayuda": {"en": "Help", "pt": "Ajuda", "fr": "Aide", "de": "Hilfe", "it": "Aiuto"},
    "Salir": {"en": "Exit", "pt": "Sair", "fr": "Quitter", "de": "Beenden", "it": "Esci"},
    "Mostrar barra de menú": {"en": "Show menu bar", "pt": "Mostrar barra de menu", "fr": "Afficher la barre de menus", "de": "Menüleiste anzeigen", "it": "Mostra barra dei menu"},
    "Ocultar barra de menú": {"en": "Hide menu bar", "pt": "Ocultar barra de menu", "fr": "Masquer la barre de menus", "de": "Menüleiste ausblenden", "it": "Nascondi barra dei menu"},
    "Exportar biblioteca": {"en": "Export library", "pt": "Exportar biblioteca", "fr": "Exporter la bibliothèque", "de": "Bibliothek exportieren", "it": "Esporta libreria"},
    "Selecciona las carpetas y subcarpetas que deseas convertir.": {"en": "Select the folders and subfolders you want to convert.", "pt": "Selecione as pastas e subpastas que deseja converter.", "fr": "Sélectionnez les dossiers et sous-dossiers à convertir.", "de": "Wähle die Ordner und Unterordner für die Konvertierung.", "it": "Seleziona le cartelle e sottocartelle da convertire."},
    "Normalizar al pico seguro sin distorsión": {"en": "Normalize to a safe peak without distortion", "pt": "Normalizar ao pico seguro sem distorção", "fr": "Normaliser au pic sûr sans distorsion", "de": "Auf sicheren Spitzenpegel ohne Verzerrung normalisieren", "it": "Normalizza al picco sicuro senza distorsione"},
    "Destino:": {"en": "Destination:", "pt": "Destino:", "fr": "Destination :", "de": "Ziel:", "it": "Destinazione:"},
    "Unidad extraíble": {"en": "Removable drive", "pt": "Unidade removível", "fr": "Lecteur amovible", "de": "Wechseldatenträger", "it": "Unità rimovibile"},
    "Elegir otro directorio…": {"en": "Choose another folder…", "pt": "Escolher outro diretório…", "fr": "Choisir un autre dossier…", "de": "Anderen Ordner wählen…", "it": "Scegli un'altra cartella…"},
    "Sincronizar: copiar solo archivos nuevos o modificados": {"en": "Sync: copy only new or changed files", "pt": "Sincronizar: copiar somente arquivos novos ou modificados", "fr": "Synchroniser : copier uniquement les fichiers nouveaux ou modifiés", "de": "Synchronisieren: nur neue oder geänderte Dateien kopieren", "it": "Sincronizza: copia solo file nuovi o modificati"},
    "archivos ya sincronizados": {"en": "files already synchronized", "pt": "arquivos já sincronizados", "fr": "fichiers déjà synchronisés", "de": "Dateien bereits synchronisiert", "it": "file già sincronizzati"},
    "La selección no contiene pistas.": {"en": "The selection contains no tracks.", "pt": "A seleção não contém faixas.", "fr": "La sélection ne contient aucune piste.", "de": "Die Auswahl enthält keine Titel.", "it": "La selezione non contiene brani."},
    "Modo local": {"en": "Local mode", "pt": "Modo local", "fr": "Mode local", "de": "Lokaler Modus", "it": "Modalità locale"},
    "Las búsquedas en internet están desactivadas en Configuración.": {"en": "Internet searches are disabled in Settings.", "pt": "As pesquisas na internet estão desativadas nas Configurações.", "fr": "Les recherches Internet sont désactivées dans les Paramètres.", "de": "Internetsuchen sind in den Einstellungen deaktiviert.", "it": "Le ricerche su Internet sono disattivate nelle Impostazioni."},
    "No descargar información de internet (modo local)": {"en": "Do not download information from the internet (local mode)", "pt": "Não baixar informações da internet (modo local)", "fr": "Ne pas télécharger d’informations depuis Internet (mode local)", "de": "Keine Informationen aus dem Internet herunterladen (lokaler Modus)", "it": "Non scaricare informazioni da Internet (modalità locale)"},
    "Usa portadas de las carpetas, imágenes elegidas manualmente y metadatos de los archivos.": {"en": "Uses folder covers, manually selected images, and file metadata.", "pt": "Usa capas das pastas, imagens escolhidas manualmente e metadados dos arquivos.", "fr": "Utilise les pochettes des dossiers, les images choisies manuellement et les métadonnées des fichiers.", "de": "Verwendet Ordnercover, manuell ausgewählte Bilder und Dateimetadaten.", "it": "Usa le copertine delle cartelle, le immagini scelte manualmente e i metadati dei file."},
    ...
    "Duración total": {"en": "Total duration", "pt": "Duração total", "fr": "Durée totale", "de": "Gesamtdauer", "it": "Durata totale"},
    "promedio": {"en": "average", "pt": "média", "fr": "moyenne", "de": "Durchschnitt", "it": "media"},
    "Pistas sueltas": {"en": "Loose tracks", "pt": "Faixas soltas", "fr": "Pistes indépendantes", "de": "Lose Titel", "it": "Brani singoli"},
    "Revisando biblioteca…": {"en": "Scanning library…", "pt": "Verificando biblioteca…", "fr": "Analyse de la bibliothèque…", "de": "Bibliothek wird geprüft…", "it": "Analisi della libreria…"},
    ...
    "MP3 · hasta 128 kbps": {"en": "MP3 · up to 128 kbps", "pt": "MP3 · até 128 kbps", "fr": "MP3 · jusqu’à 128 kbps", "de": "MP3 · bis zu 128 kbit/s", "it": "MP3 · fino a 128 kbps"},
    "WMA · hasta 160 kbps": {"en": "WMA · up to 160 kbps", "pt": "WMA · até 160 kbps", "fr": "WMA · jusqu’à 160 kbps", "de": "WMA · bis zu 160 kbit/s", "it": "WMA · fino a 160 kbps"},
    ...
    "Minimizar a la bandeja": {"en": "Minimize to tray", "pt": "Minimizar para a bandeja", "fr": "Réduire dans la zone de notification", "de": "In den Infobereich minimieren", "it": "Riduci nell’area di notifica"},
    "Mostrar progreso": {"en": "Show progress", "pt": "Mostrar progresso", "fr": "Afficher la progression", "de": "Fortschritt anzeigen", "it": "Mostra avanzamento"},
    "Cancelar exportación": {"en": "Cancel export", "pt": "Cancelar exportação", "fr": "Annuler l’exportation", "de": "Export abbrechen", "it": "Annulla esportazione"},
    "Cancelando…": {"en": "Cancelling…", "pt": "Cancelando…", "fr": "Annulation…", "de": "Wird abgebrochen…", "it": "Annullamento…"},
    "Exportación en curso": {"en": "Export in progress", "pt": "Exportação em andamento", "fr": "Exportation en cours", "de": "Export läuft", "it": "Esportazione in corso"},
    "Mostrar Vinqelo": {"en": "Show Vinqelo", "pt": "Mostrar Vinqelo", "fr": "Afficher Vinqelo", "de": "Vinqelo anzeigen", "it": "Mostra Vinqelo"},
    "Salir de Vinqelo": {"en": "Exit Vinqelo", "pt": "Sair do Vinqelo", "fr": "Quitter Vinqelo", "de": "Vinqelo beenden", "it": "Esci da Vinqelo"},
    "Vinqelo seguirá disponible aquí mientras reproduce música.": {"en": "Vinqelo will remain available here while playing music.", "pt": "O Vinqelo continuará disponível aqui enquanto reproduz música.", "fr": "Vinqelo restera disponible ici pendant la lecture.", "de": "Vinqelo bleibt während der Wiedergabe hier verfügbar.", "it": "Vinqelo resterà disponibile qui durante la riproduzione."},
    ...
    "PISTAS": {"en": "TRACKS", "pt": "FAIXAS", "fr": "PISTES", "de": "TITEL", "it": "BRANI"},
    "CARPETA": {"en": "FOLDER", "pt": "PASTA", "fr": "DOSSIER", "de": "ORDNER", "it": "CARTELLA"},
    ...
    "Preamplificador y ecualizador configurable de 6 bandas.": {"en": "Configurable preamp and 6-band equalizer.", "pt": "Pré-amplificador e equalizador configurável de 6 bandas.", "fr": "Préampli et égaliseur 6 bandes configurables.", "de": "Konfigurierbarer Vorverstärker und 6-Band-Equalizer.", "it": "Preamplificatore ed equalizzatore configurabile a 6 bande."},
    ...
    "Código fuente": {"en": "Source code", "pt": "Código-fonte", "fr": "Code source", "de": "Quellcode", "it": "Codice sorgente"},
    "Detalles": {"en": "Details", "pt": "Detalhes", "fr": "Détails", "de": "Details", "it": "Dettagli"},
