...
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.mp3\shell\open"; ValueType: string; ValueName: "MultiSelectModel"; ValueData: "Player"; Tasks: fileassoc
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.mp3\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" %*"; Tasks: fileassoc
...
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.flac\shell\open"; ValueType: string; ValueName: "MultiSelectModel"; ValueData: "Player"; Tasks: fileassoc
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.flac\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" %*"; Tasks: fileassoc
...
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.wav\shell\open"; ValueType: string; ValueName: "MultiSelectModel"; ValueData: "Player"; Tasks: fileassoc
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.wav\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" %*"; Tasks: fileassoc
...
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.ogg\shell\open"; ValueType: string; ValueName: "MultiSelectModel"; ValueData: "Player"; Tasks: fileassoc
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.ogg\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" %*"; Tasks: fileassoc
...
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.m4a\shell\open"; ValueType: string; ValueName: "MultiSelectModel"; ValueData: "Player"; Tasks: fileassoc
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.m4a\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" %*"; Tasks: fileassoc
...
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.aac\shell\open"; ValueType: string; ValueName: "MultiSelectModel"; ValueData: "Player"; Tasks: fileassoc
Root: HKA; Subkey: "Software\Classes\VinqeloPlayer.aac\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" %*"; Tasks: fileassoc
